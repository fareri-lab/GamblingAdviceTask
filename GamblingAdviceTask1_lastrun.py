...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\farerilab\\Documents\\GitHub\\GamblingAdviceTask\\GamblingAdviceTask1.psyexp',
...
receiveMoneyPicture = visual.ImageStim(
    win=win, name='receiveMoneyPicture',
    image='sin', mask=None,
