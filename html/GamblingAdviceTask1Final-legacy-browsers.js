...
function Receive_moneyRoutineBegin(trials) {
  return function () {
    ...
    Receive_moneyComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function askAdRoutineBegin(trials) {
  return function () {
    ...
    askAdComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function getAdRoutineBegin(trials) {
  return function () {
    ...
    getAdComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function Choice2GainRoutineBegin(trials) {
  return function () {
    ...
    Choice2GainComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
