...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\farerilab\\Downloads\\Test.psyexp',
...
trials_3 = data.TrialHandler(nReps=1, method='random', 
    ...
    trialList=data.importConditions(u'GamblingAdviceTask\\Conditions.csv'),
...
for thisTrial_3 in trials_3:
    ...
    for thisTrial in trials:
        ...
        # update component parameters for each repeat
        receive.setColor(u'white', colorSpace='rgb')
        receive.setPos((0.0, 0))
        receive.setHeight(0.1)
        receive.setFont(u'Arial')
        ...
        Advice.setColor(u'white', colorSpace='rgb')
        Advice.setPos((0, 0))
        Advice.setHeight(0.08)
        Advice.setFont(u'Arial')
