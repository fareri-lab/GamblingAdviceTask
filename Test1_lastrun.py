...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\farerilab\\Documents\\GitHub\\GamblingAdviceTask\\Test1.psyexp',
...
instructions = visual.TextStim(win=win, name='instructions',
    text=u'\nWelcome to the experiment.\n\n\nIn the following page you will be instructed to choose an advisor. \n\nPress the space bar when you are ready to proceed.',
    font=u'Arial',
...
instComponents = [instructions, key_resp_2]
...
# keep track of which components have finished
preBlockComponents = [chooseInst, text_2, text_4, key_resp_3, image_6, image_7, key_resp_4]
...
for thisTrial_3 in trials_3:
    ...
    # set up handler to look after randomisation of conditions etc
    trials = data.TrialHandler(nReps=nRepsblock1, method='fullRandom', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Conditions.csv'),
    ...
    for thisTrial in trials:
        ...
        # update component parameters for each repeat
        text_5.setColor(u'white', colorSpace='rgb')
        text_5.setText(u'+')
        text_5.setPos((0, 0))
        text_5.setFont(u'Arial')
        text_5.setHeight(0.08)
        text_7.setColor(u'white', colorSpace='rgb')
        text_7.setText(Amount)
        text_7.setPos((0, 0))
        text_7.setFont(u'Arial')
        text_7.setHeight(0.1)
        isi2.setColor(u'white', colorSpace='rgb')
        isi2.setText(u'+')
        isi2.setPos((0, 0))
        isi2.setFont(u'Arial')
        isi2.setHeight(0.08)
        # keep track of which components have finished
        ISIComponents = [text_5, text_7, isi2]
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            # *text_7* updates
            if t >= 3 and text_7.status == NOT_STARTED:
                # keep track of start time/frame for later
                text_7.tStart = t
            ...
            # *isi2* updates
            if t >= 5 and isi2.status == NOT_STARTED:
                # keep track of start time/frame for later
                isi2.tStart = t
    ...
    # set up handler to look after randomisation of conditions etc
    trials_2 = data.TrialHandler(nReps=nRepsblock2, method='fullRandom', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Conditions.csv'),
    ...
    for thisTrial_2 in trials_2:
        ...
        image_3.setImage(Loss1)
        image_3.setPos((0, 0))
        image_3.setSize((1.3, 0.9))
        image_3.setOpacity(1)
        image_3.setOri(0)
        resp2 = event.BuilderKeyResponse()
        checkR.setImage('check3.png')
        checkR.setPos((0, 0))
        checkR.setSize((2, 1))
        checkR.setOpacity(1)
        checkR.setOri(0)
        checkL.setImage('check2.png')
        checkL.setPos((0, 0))
        checkL.setSize((2, 1))
        checkL.setOpacity(1)
        checkL.setOri(0)
