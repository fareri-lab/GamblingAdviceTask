...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v3.1.2),
    on July 03, 2019, at 12:26
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\farerilab\\Downloads\\GamblingAdviceTask\\experiment.psyexp',
...
text = visual.TextStim(win=win, name='text',
    text='\nWelcome to the experiment.\nIn the following page you will \nbe instructed to choose an\nadvisor. Press the space bar\nwhen you are ready to proceed.',
    font='Arial',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='Please choose which person you would want to recieve advice from and press then press enter',
    font='Arial',
...
image = visual.ImageStim(
    win=win, name='image',
    image=u'avatar_1.png', mask=None,
...
image_2 = visual.ImageStim(
    ...
    image=u'avatar_2.png', mask=None,
...
# keep track of which components have finished
preblockComponents = [text_2, text_3, text_4, key_resp_3, image, image_2, key_resp_4]
...
while continueRoutine:
    ...
    if text_3.status == FINISHED:
        border_left.autoDraw = False
    
    if text_4.status==FINISHED:
